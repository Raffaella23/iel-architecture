...
const SCENES = [
  ...
  },
  {
    id: 'piano1',
    image: null,
    images: ['/images/piano_primo_v1.png', '/images/piano_primo_v2.png'],
    label: 'Il Piano',
    ...
    replay: 'La vetrata a tutta altezza nasce da un gesto preciso: liberare uno spazio che era stato chiuso nel tempo. Dove c\'era un balcone murato, oggi entra la luce. Il profilo dell\'infisso scompare nella struttura — quello che rimane è solo il paesaggio.',
    mood: true,
  },
  {
    id: 'materiali',
    ...
    replay: 'La scelta dei materiali non è estetica — è climatica. Il travertino accumula calore di giorno e lo rilascia di notte. Il rovere invecchia bene nel clima mediterraneo.',
    mood: false,
  },
];
    ...
    <div className="welcome-screen">
      <div className="welcome-content">
        ...
        <p className="welcome-body">
          ...
          Oggi esplorerete 4 decisioni progettuali<br />
...
export default function App() {
  const [phase, setPhase] = useState('welcome'); // welcome | explore | summary
  ...
  // ── WELCOME ──
  if (phase === 'welcome') {
    return <WelcomeScreen onStart={() => setPhase('explore')} />;
  }
    ...
    <div className="app">
      ...
      <header className="header">
        ...
        <div className="header-right-row">
          <button className="summary-btn" onClick={() => setPhase('summary')}>
            Riepilogo
          </button>
